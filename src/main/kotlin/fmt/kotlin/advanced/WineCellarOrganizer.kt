...
class WineCellarOrganizer<T: Bottle>(vararg winRackAvailable: Pair<Int, Capacity>) {
    ...
    fun takeCommonBottleOf(color: Color, region: Region): T? =
        takeBottleOf(color, region, COMMON)

    fun takeGoodBottleOf(color: Color, region: Region): T? =
        takeBottleOf(color, region, GOOD)

    fun takeBestBottleOf(color: Color, region: Region): T? =
        takeBottleOf(color, region, BEST)
    ...
    fun viewCommonBottleOf(color: Color, region: Region): T? =
        viewBottleOf(color, region, COMMON)

    fun viewGoodBottleOf(color: Color, region: Region): T? =
        viewBottleOf(color, region, GOOD)

    fun viewBestBottleOf(color: Color, region: Region): T? =
        viewBottleOf(color, region, BEST)
    ...
    fun viewWineRackOf(region: Region): Rack<T>? =
        selectRack(region)

    fun viewNumberOfWineRacks(): Int =
        wineCellar.numberOfRacks
    ...
    private fun selectRack(region: Region): Rack<T>? =
        wineCellar.wineRacks[region.name]
